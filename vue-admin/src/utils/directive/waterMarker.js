...
WaterMark.prototype = {
  ...
  _init: function (node, options) {
    this.options = {
      ...
      opacity: options.opacity ? options.opacity : 0.09, // 水印透明度
      xSpace: options.xSpace ? options.xSpace : 100, // 横向间隔
      ySpace: options.ySpace ? options.ySpace : 80, // 纵向间隔
      ...
      fontSize: options.fontSize ? options.fontSize : 14, // 字体大小
      color: options.color ? options.color : '#888', // 字体颜色

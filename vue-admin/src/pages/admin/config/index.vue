<template>
  <a-card>
    <types v-model:type_id="configInfo.type_id" :types="configInfo.types" @reload="getConfigs" />
    <a-row justify="center" :style="{ padding: '20px 0 30px 0' }">
      <a-col :xs="24" :sm="24" :md="14" :lg="12" :xl="10" :xxl="8">
        <dynamic-form ref="dynamicFormRef" :key="dynamicFormKey" v-model:data="configInfo.datas" />
        <a-button-group>

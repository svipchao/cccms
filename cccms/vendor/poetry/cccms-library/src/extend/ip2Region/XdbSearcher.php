...
namespace cccms\extend\ip2Region;

// Copyright 2022 The Ip2Region Authors. All rights reserved.
// Use of this source code is governed by an Apache2.0-style
...
class XdbSearcher
{
    ...
    private mixed $vectorIndex = null;

    // xdb content buffer
    private mixed $contentBuff = null;
     ...
     * @throws Exception
     */
    public static function newWithFileOnly($dbFile): XdbSearcher
    {
     ...
     * @throws Exception
     */
    public static function newWithVectorIndex($dbFile, $vIndex): XdbSearcher
    {
     ...
     * @throws Exception
     */
    public static function newWithBuffer($cBuff): XdbSearcher
    {
    ...
    private function read($offset, $len): ?string
    {
    ...
    public static function ip2long($ip): int|string|null
    {
        $ip = ip2long($ip);
        if ($ip === false) {
            return null;
    ...
    public static function getLong($b, $idx): int|string
    {
    ...
    public static function loadHeader($handle): ?array
    {
        if (fseek($handle, 0) == -1) {
            return null;
        }
    ...
    public static function loadHeaderFromFile($dbFile): ?array
    {
    ...
    public static function loadVectorIndexFromFile($dbFile): ?string
    {
        $handle = fopen($dbFile, 'r');
        if ($handle === false) {
            return null;
    ...
    public static function loadContent($handle): ?string
    {
    ...
    public static function loadContentFromFile($dbFile): ?string
    {

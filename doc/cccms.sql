...
INSERT INTO `sys_menu` (`id`, `parent_id`, `menu_id`, `name`, `icon`, `url`, `node`, `sort`, `status`)
VALUES (1, 0, 0, '基础系统', 'ri-stack-line', '#', '#', 0, 1),
       (2, 1, 1, '控制台', 'ri-home-line', 'admin/index/index', 'admin/index/index', 0, 1),
       (3, 1, 1, '权限配置', 'ri-shield-check-line', '#', '#', 0, 1),
       (4, 1, 3, '部门管理', '', 'admin/dept/index', 'admin/dept/index', 0, 1),
